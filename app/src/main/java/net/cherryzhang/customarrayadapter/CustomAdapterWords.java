...
import net.cherryzhang.lexicav1.ImageSaver;
import net.cherryzhang.lexicav1.ItemListActivity;
import net.cherryzhang.lexicav1.R;
import net.cherryzhang.lexicav1.Settings;
import net.cherryzhang.lexicav1.WordList.WordListBank;
import net.cherryzhang.lexicav1.WordList.WordListBank.WordItem;
