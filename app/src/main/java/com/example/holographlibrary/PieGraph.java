...
package com.example.holographlibrary;
...
public class PieGraph extends View {
    ...
    private ArrayList<com.example.holographlibrary.PieSlice> mSlices = new ArrayList<com.example.holographlibrary.PieSlice>();
