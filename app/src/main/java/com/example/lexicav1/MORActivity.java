...
public class MORActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    ArrayList<String> wordsClickedDueToInabilityToRead;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        wordsClickedDueToInabilityToRead = new ArrayList<>();
        ...
        //displays the passage in this activity.
        passage.setText(ItemDetailFragment.mItem.description);
        FontHelper.changeFont(this, passage);
        ...
        passage.setOnWordClickedListener(new TextToSpeechTextView.OnWordClickedListener()
        {
            ...
            {
                wordsClickedDueToInabilityToRead.add(word);
    ...
    private void logMORSession(double wpm, String totalTime)
    {
        Telemetry.editTelemetryLog(
                "---------------\n" +
                        ...
                        "WPM: " + wpm + "\n" +
                        "wordsClickedDueToInabilityToRead: " + wordsClickedDueToInabilityToRead);
    }
